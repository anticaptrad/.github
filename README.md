# anticaptrad organization defaults
...
This public repository is the canonical source for GitHub-supported community-health fallbacks, organization profile content, contribution guidance, public security/support policy, issue and pull-request templates, and agent-governance declarations for [`anticaptrad`](https://github.com/anticaptrad).

## Canonical organization links

- GitHub organization: https://github.com/anticaptrad
- Public organization defaults: https://github.com/anticaptrad/.github
...
`anticaptrad` declares repository roles, dependency edges, cross-organization capabilities, deployment ownership, and the git-submodule/Zed-package contract:
