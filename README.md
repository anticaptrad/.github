...
This public repository is the canonical source for GitHub-supported fallback community files, organization profile content, reusable workflow examples, and public contributor guidance for [`anticaptrad`](https://github.com/anticaptrad).

- GitHub owner: [`anticaptrad`](https://github.com/anticaptrad)
- Linear project: [github.com/anticaptrad](https://linear.app/denman/project/githubcomanticaptrad-e8b18d73b7f5)
