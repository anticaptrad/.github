...
3. Review linked pull requests, issues, Linear work, related repositories in `anticaptrad`, and relevant external-organization repositories whenever behavior or contracts cross boundaries.
